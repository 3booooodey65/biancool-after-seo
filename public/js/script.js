...
//             .setCustomValidity("رقم الهاتف غير صحيح");
//         form.classList.add("was-validated");
//         return;
//     }
...
//     saveToLocalStorage("serviceRequests", requestData);
...
//     console.log("تم حفظ طلب الخدمة:", requestData);
// }
...
//             .setCustomValidity("البريد الإلكتروني غير صحيح");
//         form.classList.add("was-validated");
//         event.preventDefault();
//         return;
//     } else {
...
//         return;
//     } else {
//         document.getElementById("contactPhone").setCustomValidity("");
//     }

//     // لو وصلنا هنا يبقى الفحص نجح والفورم هيكمل إرسال طبيعي
// }
...
document.addEventListener("DOMContentLoaded", function () {
    const ctaButtons = document.querySelectorAll(
        'a[href="request.html"], a[href="tel:+966574467922"]'
    );
...
window.addEventListener("offline", function () {
    ...
    offlineMessage.innerHTML =
        '<i class="fas fa-wifi me-2"></i>لا يوجد اتصال بالإنترنت';
